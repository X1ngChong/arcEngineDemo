...
public class ListUtils2 {
    ...
    public  ArrayList<String[]> sortAndFilterList(ArrayList<String[]> list,Map<String[], Double> map, ArrayList<String> geometryList) {
        if (list == null) {
            return new ArrayList<String[]>();
        }

        //创建一个新的ArrayList<String[]>来存储排序和过滤后的结果
        ...
        for (Map.Entry<String[], Double> entry : entryList) {
            sortedAndFilteredList.add(entry.getKey());
        }


      //  System.out.println(Arrays.toString(list.get(0)));//['99814419', '118862429', '2534398']
...
//                String firstElement = item[0];//用第一个元素去代表一个区域['475184562', '475184565', '156127007'] 选取'475184562'这个为key
...
//            if (!items.isEmpty()) {
//                sortedAndFilteredList.add( FilterByHausdorff.doFilter(geometryList,items));//添加值最低的那个 这个方法仅仅用来展示
//            }
//        }
